<div class="details-thumd">
    <div class="image-preview-container image-thick-box image_preview_container">
        <img id="img_zoom" data-zoom-image="/assets/products/<?php echo $product->name;?>/<?php echo htmlspecialchars($product->image ?? '', ENT_QUOTES, 'UTF-8'); ?>" src="/assets/products/<?php echo $product->name;?>/<?php echo htmlspecialchars($product->image ?? '', ENT_QUOTES, 'UTF-8'); ?>" alt="img">
    ...
    <div class="product-preview image-small product_preview">
        <div id="thumbnails" class="thumbnails_carousel owl-carousel" data-nav="true" data-autoplay="false" data-dots="false" data-loop="false" data-margin="10" data-responsive='{"0":{"items":3},"480":{"items":3},"600":{"items":3},"1000":{"items":3}}'>
            <a href="#" data-image="/assets/products/<?php echo $product->name;?>/<?php echo htmlspecialchars($product->image ?? '', ENT_QUOTES, 'UTF-8'); ?>" data-zoom-image="/assets/products/<?php echo $product->name;?>/<?php echo htmlspecialchars($product->image ?? '', ENT_QUOTES, 'UTF-8'); ?>" class="active">
                <img src="/assets/products/<?php echo $product->name;?>/<?php echo htmlspecialchars($product->image ?? '', ENT_QUOTES, 'UTF-8'); ?>" data-large-image="/assets/products/<?php echo $product->name;?>/<?php echo htmlspecialchars($product->image ?? '', ENT_QUOTES, 'UTF-8'); ?>" alt="img">
            </a>
