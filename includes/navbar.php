                                ...
                                <div class="category">
                                    <select title="cate" data-placeholder="All Categories" class="chosen-select"
                                        ...
                                        <?php foreach ($categories_array as $cat):
                                            if ($cat['parent_id'] === 0) { ?>
                                                <option value="category.php?id=<?php echo $cat['id']; ?>">
                            ...
                            if ($cat['parent_id'] === 0) {
                                if ($subcategories[1] > 0) { ?>
                                    <li class="menu-item menu-item-has-children">
                                        <a title="<?php echo htmlspecialchars($cat['name']); ?>" href="category.php?id=<?php echo $cat['id']; ?>" class="ysera-menu-item-title"><?php echo htmlspecialchars($cat['name']); ?></a>
                                        <span class="toggle-submenu"></span>
                                        <ul role="menu" class=" submenu">
                                            <?php while ($row = $subcategories[0]->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <li class="menu-item">
                                                    <a title="<?php echo htmlspecialchars($row['name']); ?>" href="category.php?id=<?php echo $row['id']; ?>" class="ysera-item-title"><?php echo htmlspecialchars($row['name']); ?></a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                <?php } else { ?>
                                    <li class="menu-item"><?php $cat['name']; ?>
                                        <a href="category.php?id=<?php echo $cat['id']; ?>" class="ysera-menu-item-title" title="<?php echo htmlspecialchars($cat['name']); ?>"><?php echo htmlspecialchars($cat['name']); ?></a>
                                    </li>
                                <?php }
                            } ?>
                            <?php endforeach; ?>
